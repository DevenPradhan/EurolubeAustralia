    ...
    <footer class="max-w-7xl container mx-auto">
        <div class="p-16 space-y-20 text-neutral-400 text-sm ">
            <div class="">
                ...
                <div
                    class="flex flex-col space-y-8 sm:space-y-0 sm:items-end  sm:flex-row sm:space-x-6 justify-between mt-8">
                    <div class="grid grid-cols-2 w-full gap-2.5 max-w-xl">
                        ...
                        <x-text-input type="text"
                            ...
                            placeholder="EMAIL" />
                        <a href="#" class=" bg-red-800 button_link text-sm max-w-max">sign up</a>
                    </div>
            ...
            <div class="flex space-x-20">
                <div class="max-w-2xl space-y-10 ">
                    ...
                    <p class="">We are recognized worldwide for our products, systems and solutions for pumping,
                        dispensing and
