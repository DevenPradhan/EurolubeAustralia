            ...
            <section class="w-full relative h-[750px] md:h-[900px]">
                ...
                <div class="py-44 px-4 md:px-16">
                    ...
                    <p class="text-sm tracking-wide mt-5 text-[#ffffffc7] max-w-lg">Here is a showcase of various
                        installation
                        scenarios for our products for safe and rational
                            ...
                            <div class="">
                                <div class="flex flex-col space-y-5">
                                    <div class="w-72 h-max relative group">
                                        <img src="{{ asset('images/gear-12.jpg') }}" alt="" class="w-full h-44 object-cover">
                                        <button class="services_absolute_text w-36 -right-10 top-0">Controller, meters, starts and stops the flow of fluids.</button>
                                    </div>
                                    <div class="flex space-x-3">
                                        <div class="relative w-52 group">
                                            <img src="{{ asset('images/gear-9.jpg') }}" alt="" class="w-72 h-auto">
                                            <button class="services_absolute_text w-32 bottom-0 -right-10 ">LUBE-Master Keypad, for ordering fluids.</button>
                                        </div>
                                        <div class="relative h-56 group">
                                            <img src="{{ asset('images/gear-11.jpg') }}" alt="" class="w-auto h-52">
                                            <button class="services_absolute_text right-0 bottom-0 w-28">LUBE-Master Meter Module for Oil.</>
                                        </div>
                                    </div>
                                </div>
                            </div>
